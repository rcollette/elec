...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(exports, requirejs('../shared/util.js'), requirejs('./primitives.js'),
      requirejs('./stream.js'), requirejs('./parser.js'), requirejs('./image.js'),
      requirejs('./colorspace.js'), requirejs('./murmurhash3.js'),
      requirejs('./fonts.js'), requirejs('./function.js'), requirejs('./pattern.js'),
      requirejs('./cmap.js'), requirejs('./metrics.js'), requirejs('./bidi.js'),
      requirejs('./encodings.js'), requirejs('./standard_fonts.js'),
      requirejs('./unicode.js'), requirejs('./glyphlist.js'));
  } else {
