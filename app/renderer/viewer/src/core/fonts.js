...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(exports, requirejs('../shared/util.js'), requirejs('./primitives.js'),
      requirejs('./stream.js'), requirejs('./glyphlist.js'),
      requirejs('./font_renderer.js'), requirejs('./encodings.js'),
      requirejs('./standard_fonts.js'), requirejs('./unicode.js'),
      requirejs('./type1_parser.js'), requirejs('./cff_parser.js'));
  } else {
