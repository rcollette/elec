...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(exports, requirejs('../shared/util.js'), requirejs('./font_loader.js'),
      requirejs('./canvas.js'), requirejs('./metadata.js'),
      requirejs('./dom_utils.js'));
  } else {
...
if (typeof PDFJSDev !== 'undefined' &&
  ...
  if (typeof window === 'undefined') {
    ...
    if (typeof require.ensure === 'undefined') {
      require.ensure = requirejs('node-ensure');
    }
  ...
  fakeWorkerFilesLoader = useRequireEnsure ? (function (callback) {
    require.ensure([], function () {
      var worker = requirejs('./pdf.worker.js');
  ...
  function setupFakeWorkerGlobal() {
    ...
    if (typeof PDFJSDev === 'undefined' || !PDFJSDev.test('PRODUCTION')) {
      if (typeof amdRequire === 'function') {
        ...
        var worker = requirejs('../core/worker.js');
        WorkerMessageHandler = worker.WorkerMessageHandler;
        fakeWorkerFilesLoadedCapability.resolve(WorkerMessageHandler);
      } else {
