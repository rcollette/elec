...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(exports, requirejs('../shared/util.js'), requirejs('./dom_utils.js'),
      requirejs('./api.js'), requirejs('./annotation_layer.js'),
      requirejs('./text_layer.js'), requirejs('./metadata.js'),
      requirejs('./svg.js'));
  } else {
