...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(exports, requirejs('./display/api.js'),
      requirejs('./display/annotation_layer.js'),
      requirejs('./display/text_layer.js'), requirejs('./display/dom_utils.js'),
      requirejs('./shared/util.js'), requirejs('./display/svg.js'),
      requirejs('./display/global.js'));
  } else {
