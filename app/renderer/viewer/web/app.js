...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(exports, requirejs('./ui_utils.js'), requirejs('./download_manager.js'),
      requirejs('./pdf_history.js'), requirejs('./preferences.js'),
      requirejs('./pdf_sidebar.js'), requirejs('./view_history.js'),
      requirejs('./pdf_thumbnail_viewer.js'), requirejs('./toolbar.js'),
      requirejs('./secondary_toolbar.js'), requirejs('./password_prompt.js'),
      requirejs('./pdf_presentation_mode.js'),
      requirejs('./pdf_document_properties.js'), requirejs('./hand_tool.js'),
      requirejs('./pdf_viewer.js'), requirejs('./pdf_rendering_queue.js'),
      requirejs('./pdf_link_service.js'), requirejs('./pdf_outline_viewer.js'),
      requirejs('./overlay_manager.js'), requirejs('./pdf_attachment_viewer.js'),
      requirejs('./pdf_find_controller.js'), requirejs('./pdf_find_bar.js'),
      requirejs('./dom_events.js'), requirejs('./pdfjs.js'));
  } else {
