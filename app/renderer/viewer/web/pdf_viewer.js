...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(exports, requirejs('./ui_utils.js'), requirejs('./pdf_page_view.js'),
      requirejs('./pdf_rendering_queue.js'), requirejs('./text_layer_builder.js'),
      requirejs('./annotation_layer_builder.js'),
      requirejs('./pdf_link_service.js'), requirejs('./dom_events.js'),
      requirejs('./pdfjs.js'));
  } else {
